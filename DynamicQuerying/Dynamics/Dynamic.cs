...
//I found this at http://code.msdn.microsoft.com/windowsdesktop/DynamicQuery-f65f6a4d
...
// ReSharper restore CheckNamespace
{
    public static class DynamicQueryable
    {
        ...
        {
            IQueryable<T> result = (IQueryable<T>) Where((IQueryable) source, predicate, values);
            return result;
        }
...
#pragma warning restore 0219
        ...
        private Expression ParseIdentifier()
        {
            ...
            if (keywords.TryGetValue(token.text, out value))
            {
                ...
                // Modified to remove the warning
